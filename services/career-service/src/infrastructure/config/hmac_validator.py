...
async def verify_hmac(
    ...
    # The sign path is exactly what the subjects-service signs: /internal/{careerId}/exists
    # We strip out the prefix /api/carreras
    sign_path = full_path.replace("/api/carreras", "")
